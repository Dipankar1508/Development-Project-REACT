...
const CitySearch = () => {
  ...
  return (
    <>
      <Button
        variant="outline"
        className="realtive w-full justify-start text-sm text-muted-foreground sm:pr-12 md:w-40 lg:w-64"
          ...
          <CommandList>
            ...
            {history.length > 0 && (
              <>
                <CommandSeparator />
                <CommandGroup>
                  <div className="flex flex-col items-start px-2 my-2 space-y-2">
